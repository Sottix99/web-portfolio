...
export default function Home() {
  return (
    <div>
      <Header />
      <HeroSection />
      <section id = "vision" className="pb-16 lg:py-24">
