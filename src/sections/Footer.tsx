...
export const Footer = () => {
  return <footer className="relative -z-10 overflow-x-clip">
   ...
   -translate-x-1/2 bg-emerald-300/30 [mask-image:radial-gradient(50%_50%_at_bottom_center,black,transparent)] -z-10"></div>

    <div className="container">
    <div className="border-t border-white/15 py-16 text-sm flex flex-col md:flex-row md:justify-between items-center gap-8">
      <div className="border-white/40">&copy; 2024. All rights reserved.</div>
