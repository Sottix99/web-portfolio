...
export const Hero0rbit = ({ 
    children, size, rotation, shouldOrbit = false, shouldSpin = false , orbitDuration, spinDuration}: PropsWithChildren <{size: number; rotation: number;
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -z-20">
            ...
            <div className="flex items-start justify-start" style = {{
                ...
                <div className="inline-flex" style ={{
                    transform : `rotate(${rotation * -1}deg)`}}>{children}</div>
            </div>
            </div>
            </div>
        </div>
